<template>
    <div class="tab-wrapper"> 
        <div class="v-card theme--light elevation-1 tab-navs ">
            <div :class="tabActive == 'myinfo' ? 'tab-link-item active' : 'tab-link-item'" @click="tabActive = 'myinfo'">My Information</div>
            <div :class="tabActive == 'mytickets' ? 'tab-link-item active' : 'tab-link-item'" @click="tabActive = 'mytickets'">My Tickets</div>
            <div :class="tabActive == 'favevent' ? 'tab-link-item active' : 'tab-link-item'" @click="tabActive = 'favevent'">My Favorite Events</div>
        </div>
