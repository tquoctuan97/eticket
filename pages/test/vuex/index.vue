<template>
  <v-app>
    <v-content class="main-content">
      ...
      <EventCard :posts="getUpcommingEvents"/>
      <!--end list wrapper-->
      <!--list wrapper-->
      <div class="title-box center">
        <h3>Free Entry</h3>
...
export default {
  ...
  computed: {
    ...
    getUpcommingEvents() {
      return this.$store.getters.upcommingEvents;
    },
    getFreeEvents() {
      return this.$store.getters.freeEvents;
    }
  },
  head() {
    return {
